...
const TIPS = [
  "MyMarketPlace will never ask you to send payment to a personal staff account.",
  ...
  "Keep important communication within MyMarketPlace, not just WhatsApp.",
];
  ...
  return (
    <div className={`bg-amber-50 border border-amber-200 rounded-lg p-4 ${className}`}>
      <p className="text-sm font-medium flex items-center gap-2 mb-2">
        <ShieldAlert size={16} className="text-amber-600" /> Stay safe on MyMarketPlace
      </p>
