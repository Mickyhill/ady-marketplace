  ...
  return (
    <div>
      ...
      <section className="relative overflow-hidden bg-ink-900 text-white">
        {/* Decorative layered background — pure CSS/SVG, nothing to break or reload */}
        ...
        <div className="relative max-w-6xl mx-auto px-4 py-16 text-center">
          ...
          <div className="mt-6 flex flex-wrap justify-center gap-2 text-xs">
            {["Verified sellers", "Fast local pickup", "Student-friendly prices"].map((t) => (
              <span key={t} className="px-3 py-1.5 rounded-full bg-white/15 border border-white/25 text-white backdrop-blur-sm">{t}</span>
            ))}
          </div>
        </div>
      </section>
